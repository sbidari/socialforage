function [RR,list_kappa,list_theta,av_r,av_T1,av_T2,p_1,p_2] = asHH_mc_diff_rr
...
save('/rc_scratch/subi3192/asHH_diff.mat','RR','list_kappa','list_theta','theta1','kappa1','av_T1','av_T2','p_1','p_2','av_r','alpha','B','tau','rho','T_I','Xzero')
