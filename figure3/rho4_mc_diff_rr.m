function [RR,list_kappa,list_theta,av_r,av_T1,av_T2,p_1,p_2] = rho4_mc_diff_rr
...
% save('diff_rr_rho4.mat','RR','list_kappa','list_theta','av_T1','av_T2','p_1','p_2','av_r','alpha','B','tau','rho','T_I','Xzero$
