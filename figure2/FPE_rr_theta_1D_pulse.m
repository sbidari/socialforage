function [opt_RR,opt_theta,opt_T]=FPE_rr_theta_1D_pulse(alpha,tau,n,B,T_I,Xzero,t_f,list_rho)

%--------------% Parameter space to iterate over
list_theta = -linspace(0.1,5,51);
...
legend('RR','$\theta_{opt}$','$T_{opt}$','Interpreter','latex')
